...
import com.meditail.api.services.UserService;
...
public class UserController {
	...
	@PutMapping("/users/{id}")
	public ResponseEntity<List<User>> updates(@RequestBody User user, @PathVariable Long id) {
	...
	public ResponseEntity<List<User>> deletes(@PathVariable Long id) {
		userService.delete(id);
		return ResponseEntity.ok(userService.getAll());
	}
